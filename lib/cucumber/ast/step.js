function Step(data, uri, previousStep) {
  var Cucumber = require('../../cucumber');
  var docString, dataTable;

  if (data.stepArgument){
    if (data.stepArgument.type === 'DataTable') {
      dataTable = Cucumber.Ast.DataTable(data.stepArgument);
    } else if (data.stepArgument.type === 'DocString') {
      docString = Cucumber.Ast.DocString(data.stepArgument);
    }
  }
